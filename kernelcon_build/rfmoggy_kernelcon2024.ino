...
void handleGarageSend() {  
  ...
  if( server.arg("chamber7").equals("true") ){ 
    ...
    binaryBruteSend(7, "0111", "0011", 390, 1.0, 7, 39000, 100, "", false, "", false, 2, 0);
  ...
  if( server.arg("linear8").equals("true") ){
    ...
    binaryBruteSend(8, "10000000", "11110000", 310, 2.0, 7, 32000, 100,  "", false, "", false, 2, 0);
  ...
  if( server.arg("chamber8").equals("true") ){
    ...
    binaryBruteSend(8, "0111", "0011", 390, 1.0, 7, 39000, 100, "", false, "", false, 2, 0); 
  ...
  if( server.arg("chamber9").equals("true") ){
    ...
    binaryBruteSend(9, "0111", "0011", 390, 1.0, 7, 9000, 100,  "", false, "", false, 2, 0);
  ...
  if( server.arg("stanley10").equals("true") ){
    ...
    binaryBruteSend(10, "1000", "1110", 310, 2.0, 7, 17000, 100,  "", false, "", false, 2, 0);
...
void handleWideNoiseSend(){
  ...
  //ELECHOUSE_cc1101.setDeviation(380.0);
...
/*************************************************************************/
  ...
  main_menu += "<p><a href=\"cwavenoise\">Narrow Noise</a></p>";
  main_menu += "<br>Frequency Range: 300-348 MHz, 387-464 MHz, 779-928MHz";
  main_menu += "<br>Warning: No error checks for inputs. Your responsibility to verify inputs are valid (e.g. MHz ranges)";
  main_menu += "</body></html>";
  ...
  jukebox_menu += "<button name=\"remotebutton\" type=\"submit\" value=\"volumeUpZ1\">Volume +  Zone1</button></a><br><br>";
  jukebox_menu += "<button name=\"remotebutton\" type=\"submit\" value=\"volumeDownZ1\">Volume -  Zone1</button></a><br><br>";
  jukebox_menu += "<button name=\"remotebutton\" type=\"submit\" value=\"volumeUpZ2\">Volume +  Zone2</button></a><br><br>";
  jukebox_menu += "<button name=\"remotebutton\" type=\"submit\" value=\"volumeDownZ2\">Volume -  Zone2</button></a><br><br>";
  jukebox_menu += "<button name=\"remotebutton\" type=\"submit\" value=\"volumeUpZ3\">Volume +  Zone3</button></a><br><br>";
  jukebox_menu += "<button name=\"remotebutton\" type=\"submit\" value=\"volumeDownZ3\">Volume -  Zone3</button></a><br><br>";
  jukebox_menu += "<input type=\"checkbox\" name=\"brutejuke\" value=\"true\">Brute Force Jukebox ID - takes appox 4min max<br><br>";
  jukebox_menu += "<br>Most Jukeboxes use default ID of 0x00 (PWM conversion = 1010101010101010)<br>Max value is 0xFF<br>";
  jukebox_menu += "<br>PWM conversion: 0 = 10 and 1 = 1000<br>";
  jukebox_menu += "<label>Jukebox ID (binary, converted to PWM)  </label><input type=\"text\" name=\"jukeboxID\" size=\"35\" value=\"1010101010101010\"><br>";
